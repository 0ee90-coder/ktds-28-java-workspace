...
public class PracticeQ {
	...
	public static void main(String[] args) {
		...
		System.out.println(adultcount +"명");
		System.out.println(kidcount +"명");
		
		int adultFare = adultcount * adultOneWayFlightFare;
		int kidFare = kidcount * kidOneWayFlightFare;
		int totalFare = adultFare + kidFare;
