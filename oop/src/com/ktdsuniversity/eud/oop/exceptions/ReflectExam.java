...
//		GoodsHolder holder = new GoodsHolder(4);
		...
		try {
			Class holderClass = Class.forName("com.ktdsuniversity.eud.oop.exceptions.GoodsHolder"); 
			Constructor 생성자 = holderClass.getDeclaredConstructor(int.class);   // ctrl + shift + 5
